...
class AreaModel : public QAbstractTableModel
{
    ...
    Q_PROPERTY(int areaRowsSize READ areaRowsSize WRITE setAreaRowsSize NOTIFY areaRowsSizeChanged)
    Q_PROPERTY(int areaColumnsSize READ areaColumnsSize WRITE setAreaColumnsSize NOTIFY areaColumnsSizeChanged)
